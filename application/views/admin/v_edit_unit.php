...
<head>
  ...
  <title>KOPERASI INTI | Add Unit</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/unit/add_unit'?>"><i class="fa fa-thumb-tack"></i> Add Unit</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form action="<?php echo base_url().'admin/unit/update_unit'?>" method="post" enctype="multipart/form-data">
		
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              <input type="hidden" name="kode" value="<?php echo $b['unit_id'];?>" required>
              <input type="text" name="xjudul" class="form-control" value="<?php echo $b['unit_judul'];?>" placeholder="Judul" required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="box box-danger">
			...
			<textarea id="ckeditor" name="xisi" required><?php echo $b['unit_deskripsi'];?></textarea>
