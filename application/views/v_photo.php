...
<html class="no-js">
			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li class="active"><a href="<?php echo base_url().'struktur'?>">Struktur Organisasi</a></li>
  ...
  <div class="container">
    <div class="row"><br/>
      ...
      <div class="col-md-4">
        <a class="example-image-link" href="<?php echo base_url().'assets/images/'.$row->photo_gambar;?>" data-lightbox="example-2" data-title="<?php echo $row->photo_judul;?>"><img class="example-image img-responsive" src="<?php echo base_url().'assets/images/'.$row->photo_gambar;?>" alt="image-1"/></a>
      </div>
      <?php endforeach;?>
    </div>
  </div>
