			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li class="active"><a href="<?php echo base_url().'unit'?>">Unit</a></li>
	...
	<div id="fh5co-grid-products" class="animate-box">
		...
		<?php
			foreach ($data->result_array() as $i) :
				...
				$unit_deskripsi=$i['unit_deskripsi'];
				$unit_author=$i['unit_author'];
				$unit_image=$i['unit_image'];
				$unit_tglpost=$i['tanggal'];

		?>
		<div class="col-md-4">
			<a href="#" ><img src="<?php echo base_url().'assets/images/'.$unit_image;?>" class="img-responsive"></a>
				<div class="v-align">
					<div class="v-align-middle"><br/>
						<h3 class="title" style="color:black"><?php echo $unit_judul;?></h3>
						<h5 class="category" style="color:black"><?php echo $unit_deskripsi;?></h5>
					</div>
				</div>
		</div>
		<?php endforeach;?>
