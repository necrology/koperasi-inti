...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Agu 2020 pada 07.51
...
(5, 'STRUKTUR ORGANISASI', '2020-08-19 01:13:21', 2, 'Admin', 1, '12708afe8dc7eb05d5f0af24dacc28d1.png');
...
(6, 'Rapat Anggota', '2020-08-18 02:10:05'),
(7, 'Kunjungan', '2020-08-18 02:10:49'),
(8, 'Uncategorize', '2020-08-18 02:11:24');
...
(2, 'Admin', NULL, 'L', 'admin', '21232f297a57a5a743894a0e4a801fc3', NULL, 'admin@gmail.com', '123456789', NULL, NULL, NULL, NULL, 1, '1', '2020-08-18 02:23:29', '9c024533449d3a712ebd0bd5e244a8d4.png');
...
(946, '2020-08-17 16:52:02', '::1', 'Firefox'),
(947, '2020-08-17 17:00:07', '::1', 'Firefox'),
(948, '2020-08-19 00:52:11', '::1', 'Chrome'),
(949, '2020-08-24 18:16:07', '::1', 'Chrome');
...
CREATE TABLE `tbl_photo` (
  ...
  `photo_judul` varchar(60) DEFAULT NULL,
  `photo_tanggal` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `photo_gambar` varchar(40) DEFAULT NULL,
  `photo_album_id` int(11) DEFAULT NULL,
  `photo_pengguna_id` int(11) DEFAULT NULL,
  `photo_author` varchar(60) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_photo` (`photo_id`, `photo_judul`, `photo_tanggal`, `photo_gambar`, `photo_album_id`, `photo_pengguna_id`, `photo_author`) VALUES
(20, 'Struktur Organisasi', '2020-08-19 01:13:56', '2cec7f22e2463fda4f736e188c8011d1.png', 5, 2, 'Admin');
...
(55, '2020-08-17 17:21:13', '::1', 31),
(56, '2020-08-17 17:21:14', '::1', 0),
(57, '2020-08-17 17:21:20', '::1', 30),
(58, '2020-08-17 17:21:28', '::1', 29),
(59, '2020-08-17 17:21:35', '::1', 28),
(60, '2020-08-17 17:21:41', '::1', 27),
(61, '2020-08-18 02:19:53', '::1', 33),
(62, '2020-08-19 01:22:05', '::1', 37),
(63, '2020-08-19 01:22:07', '::1', 0);
...
(32, 'Dasar Hukum Koperasi', '<p><strong>1. Undang-undang No. 25 Tahun 1992</strong></p>\r\n\r\n<p>Undang-undang No. 25 Tahun 1992 tentang Perkoperasian. Dalam undang undang ini menegaskan bahwa pembinaan koperasi, pengesahan perubahan anggaran dasar dan pemberian status badan hukum koperasi merupakan wewenang serta tanggung jawab pemerintah. Wewenang tersebut dapat dilimpahkan pada menteri yang membidangi koperasi. Dengan demikian pemerintah bukan untuk mencampuri urusan internal organisasi koperasi namun hanya mengawasi dan memperhatikan prinsip kemandirian koperasi.</p>\r\n\r\n<p><strong>2. Peraturan Pemerintah No. 4 tahun 1994</strong></p>\r\n\r\n<p>Peraturan Pemerintah No. 4 tahun 1994 tentang Persyaratan dan Tata Cara Pengesahan Akta Pendirian dan Perubahan Anggaran Dasar Koperasi. Koperasi perlu diberikan status badan hukum agar dapat melaksanakan fungsi dan perannya secara efektif . Untuk mendapatkan status badan hukum koperasi harus memperoleh akta pendirian yang sudah mendapatkan pengesahan dari pemerintah yang selanjutnya koperasi bertindak secara mandiri dan melakukan tindakan hukum sesuai maksud dan tujuannya.</p>\r\n\r\n<p><strong>3. Peraturan Pemerintah No. 17 tahun 1994</strong></p>\r\n\r\n<p>Peraturan Pemerintah No. 17 tahun 1994 tentang Pembubaran Koperasi oleh Pemerintah. Pembubaran koperasi dilakukan apabila kegiatan koperasi dirasa membahayakan atau menghambat sistem koperasi misalnya kelangsungan hidupnya sudah tidak dapat dipertahankan lagi meskipun sudah diberikan bantuan sekalipun atau tidak berjalan sesuai dengan undang-undang atau anggaran dasar koperasi maka koperasi seperti ini sebaiknya di bubarkan. Pembubaran koperasi hanya dapat dilakukan oleh pemerintah yang berwenang dengan segala jenis pertimbangan</p>\r\n\r\n<p><strong>4. Peraturan Pemerintah No. 9 tahun 1995</strong></p>\r\n\r\n<p>Peraturan Pemerintah No. 9 tahun 1995 tentang Pelaksanaan Kegiatan Simpan Pinjam oleh Koperasi. Kegiatan simpan pinjam sangat dibutuhkan oleh para anggota koperasi salah satunya untuk meningkatkan modal usaha mereka. Maka dari itu dalam peraturan pemerintah ini dimuat ketentuan yang bertujuan agar kegiatan simpan pinjam yang dilakukan oleh koperasi berkembang dan berjalan secara jelas, mandiri, teratur dan tangguh. Selain itu juga memuat ketentuan untuk mengantisipasi prospek masa depan dimana modal usaha sangat menentukan kelangsungan hidup dan anggota yang bersangkutan.</p>\r\n\r\n<p><strong>5. Peraturan Pemerintah No. 33 tahun 1998</strong></p>\r\n\r\n<p>Peraturan Pemerintah No. 33 tahun 1998 tentang Modal Penyertaan pada Koperasi. Peraturan pemerintah ini mengatur tentang prinsip modal yang meliputi sumber modal penyertaan, hak dan kewjiban, pengelolaan dan pengawasan, perjanjian sebagai dasar penyelenggaraan, pengalihan modal penyertaan dan ketentuan peralihan dibiayai oleh modal penyertaan bagi koperasi yang selama ini telah menyelenggarakan usaha. Pelaksanaan modal penyertaan perlu diatur dalam sebuah peraturan pemerintah untuk mempertegas kedudukan modal penyertaan dan memberikan kepastian hukum bagi pemodal dan koperasi.</p>\r\n\r\n<hr />\r\n<p>sumber :&nbsp;<a href=\"https://dosenekonomi.com/ilmu-ekonomi/koperasi/dasar-hukum-koperasi\">dosenekonomi.com</a></p>\r\n', '2020-08-18 02:13:27', 8, 'Uncategorize', 0, '9789275841a7cc5b0165f046c80e780c.jpg', 1, 'Administrator', 0, 'dasar-hukum-koperasi.html', 0),
(33, 'RAT Tahun Buku 2017', '<p><strong>Bandung, 29 Maret 2018</strong> serah terima hadiah kepada Anggota Koperasi Inti kiri bapak Kusno Prijono (Ketua), tengah bapak Harmen Mesta (anggota koperasi), kanan bapak Kosasih (Sekretaris).</p>\r\n\r\n<p>RAT atau singkatan dari Rapat Anggota Tahunan ini, merupakan suatu agenda wajib di dalam kepengurusan koperasi, karena di dalam rapat tersebut akan terjadi pertanggung jawaban pengurus koperasi selama satu tahun kepada para anggota koperasi yang bersangkutan.</p>\r\n\r\n<p>Dalam acara Rapat Anggota Tahunan (RAT) Tahun Buku 2017 kali ini mengadakan undian berhadiah bagi para anggota KOPERASI INTI. Banyak sekali hadiah yang disediakan Koperasi untuk para anggota , salah satu hadiah yang paling dinanti oleh para anggota adalah 1 Unit Sepeda yang kali ini di bawa pulang oleh Bapak Harmen Mesta. Pemberian hadiah secara simbolis oleh Bapak Kusno Prijono selaku ketua Koperasi dan didampingi oleh Bapak Kosasih selaku Sekrtaris KOperasi inti.</p>\r\n', '2020-08-18 02:14:59', 6, 'Rapat Anggota', 1, 'dee2e3c921391b14056f7cb121346c05.jpg', 1, 'Administrator', 0, 'rat-tahun-buku-2017.html', 0),
(34, 'RAT Tahun Buku 2017', '<p><strong>Bandung, 29 Maret 2018</strong>&nbsp;Pembukaan Pelaksanaan Rapat Anggota Tahunan Tahun Buku 2017.</p>\r\n\r\n<p>RAT atau singkatan dari Rapat Anggota Tahunan ini, merupakan suatu agenda wajib di dalam kepengurusan koperasi, karena di dalam rapat tersebut akan terjadi pertanggung jawaban pengurus koperasi selama satu tahun kepada para anggota koperasi yang bersangkutan.</p>\r\n\r\n<p>Dalam RAT tersebut disampaikan beberapa laporan tahunan yang memuat hal-hal yang perlu diketahui dalam RAT yang merupakan kekuasaan tertinggi dalam organisasi koperasi untuk dapat dibahas dan sekaligus berdasarkan musyawarah mufakat bersama mendapat pengesahan dari seluruh anggota. Selain itu, ada beberapa paparan serta sesi tanya jawab antar pengurus dan anggota koperasi.</p>\r\n', '2020-08-18 02:15:53', 6, 'Rapat Anggota', 0, '5404953b2650e3b04f3b102ffd182baa.jpg', 1, 'Administrator', 0, 'rat-tahun-buku-2017.html', 0),
(35, 'Kunjungan Kerja Koperasi Malaysia', '<p><strong>Bandung, 17 Februari 2018</strong> Kunjungan kedatangan Delegasi Lawatan Koperasi Pegawai Kerajaan Negeri Melaka Berhad dalam melengkapi agendanya ke Indonesia mengunjungi Koperasi INTI sebagai kunjungan persahabatan antara kedua Negara.</p>\r\n\r\n<p>Kunjungan ini merupakan ajang silaturahmi dan kerja sama kedua koperasi demi mewujudkan kesejahteraan para anggota Koperasi. Dengan tujuan antara lain :</p>\r\n\r\n<ol>\r\n	<li>Meningkatkan pemanfaatan sumber daya dan sumber dana yang berasal dari dalam gerakan koperasi secara efisien supaya memunculkan kelipatan daya guna yang semakin tepat.</li>\r\n	<li>Memperluas usaha antar koperasi agar manfaat ekonomis jatuh ditangan koperasi.</li>\r\n	<li>Koperasi sebagai kekuatan ekonomi nasional yang tangguh melalui alih sumber daya teknologi dari satu koperasi kepada koperasi yang lain.</li>\r\n	<li>Menggalang tumbuhnya kepercayaan anggota maupun masyarakat terhadap koperasi melalui usaha-usaha yang semakin terpadu dalam satu lingkup sistem yang terarah.</li>\r\n	<li>Menaikkan sumbangan koperasi terhadap pembentukan produksi nasional secara lebih terarah.</li>\r\n	<li>&nbsp;&nbsp;Memajukan dan mengembangkan baik pada anggota koperasi atau koperasi itu sendiri.</li>\r\n	<li>&nbsp;Memperoleh keuntungan yang disebabkan karena bisa beroperasi secara besar-besaran (<em>economic of scale</em>)</li>\r\n</ol>\r\n', '2020-08-18 02:17:00', 7, 'Kunjungan', 0, 'ae93c61d43973688dde3eb75f5612007.jpg', 1, 'Administrator', 0, 'kunjungan-kerja-koperasi-malaysia.html', 0),
(36, 'Pemberian Cinderamata', '<p>Serah Terima Cinderamata kepada Kepala Koperasi Kerajaan Melaka Berhad Malaysia.</p>\r\n\r\n<p>Pada kunjungan kedatangan Delegasi Lawatan Koperasi Pegawai Kerajaan Negeri Melaka Berhad Hari sabtu 17 Februari,&nbsp;dalam melengkapi agendanya ke Indonesia mengunjungi Koperasi INTI.</p>\r\n\r\n<p>koperasi inti memberikan cinderamata berupa wayang golek si cepot sebagai simbol kesenian jawa barat kepada kepala koperasi kerajaan melaka berhad malaysia. Untuk kedepannya kerjasama antar kedua negara diharapkan berjalan dengan lancar.</p>\r\n', '2020-08-18 02:17:40', 7, 'Kunjungan', 0, '5c0a1a71153e89b710a7f085b2fe5cab.jpg', 1, 'Administrator', 0, 'pemberian-cinderamata.html', 0),
(37, 'RKA 2017', '<p>Bandung, 29 Desember 2017 Ketua Koperasi Inti Bapak Kusno Prijono, ST.,MT. dalam Pembukaan Acara RKA (Rencana Kerja dan Anggaran) tahun 2018.</p>\r\n\r\n<p>Rapat anggota koperasi merupakan suatu wadah dari para anggota koperasi yang diorganisasikan oleh pengurus koperasi, untuk membahas seluruh permasalah untuk kepentingan organisasi koperasi dan usaha koperasi. Rapat organisasi dilaksanakan untuk mengambil suatu keputusan yang mengikuti asas musyawarah mufakat dengan keputusan suara terbanyak dari para anggota yang hadir. Dalam melaksanakan rapat anggota koperasi pelaksanaanya harus mengikuti aturan aturan yang telah diatur dalam anggaran dasar dan anggaran rumah tangga yang ada. Suatu koperasi ataupun organisasi formal lainnya seharusnya mengatur tentang rapat anggota mulai dari waktu pelaksanaan, jumlah anggota quorum, aturan atau tata tertib acara rapat anggota dan berbagai hal yang dibutuhkan untuk menertibkan jalannya rapat anggota koperasi serta kerja kerja koperasi selanjutnya.</p>\r\n\r\n<p>Setiap akhir tahun koperasi inti melakukan perencanaan kerja dan anggaran untuk tahun berikut nya, agar setiap tahun anggaran dan rencana kerja dapat dilakukan dengan baik dan terperinci untuk penulisan laporan mingguan, bulanan dan tahunan.</p>\r\n', '2020-08-18 02:18:25', 6, 'Rapat Anggota', 1, '7264e6a9436f16aa61f3520f67b884b2.jpg', 1, 'Administrator', 0, 'rka-2017.html', 0);
...
CREATE TABLE `tbl_unit` (
  ...
  `unit_judul` varchar(200) DEFAULT NULL,
  `unit_deskripsi` text,
  `unit_tanggal` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `unit_author` varchar(40) DEFAULT NULL,
  `unit_image` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_unit` (`unit_id`, `unit_judul`, `unit_deskripsi`, `unit_tanggal`, `unit_author`, `unit_image`) VALUES
(11, 'KERJASAMA PERBANKAN & MITRA KERJA', '<hr />\r\n<p>Bekerja sama dengan berbagai macam perbankan dan mitra kerja.</p>\r\n', '2020-08-17 18:32:37', 'Admin', 'f68b0aad5b125ae77415873d2f226e5c.png'),
(12, 'UNIT PENDUKUNG', '<hr />\r\n<p>SDM, UMUM, AKUNTANSI&amp;KEUANGAN, DAN PEMASARAN.</p>\r\n', '2020-08-17 18:34:09', 'Admin', 'af5471ca626660f0110ed99980482072.png'),
(13, 'UNIT USAHA - SEWA ALAT OLAH DATA', '<hr />\r\n<p>Melayani sewa laptop dengan harga yang menarik.</p>\r\n\r\n<p>Melayani sewa CCTV indoor dan outdoor.</p>\r\n', '2020-08-17 18:44:21', 'Admin', '16b2c30e797ded8e136edd520c616454.jpg'),
(14, 'UNIT USAHA - PERNIAGAAN', '<p>BIDANG NIAGA</p>\r\n\r\n<hr />\r\n<p>Pengadaan Alat Olah Data (Laptop, Printer, ...)<br />\r\nPengadaan Tool/Alat Ukur (OPM, Splicer, GPS, ...)<br />\r\nPengadaan Material&nbsp; Telekomunikasi (Rack, Tiang, ...)<br />\r\nPerdagangan&nbsp; Umum<br />\r\nPekerjaan Proyek&nbsp; Telekomunikasi</p>\r\n', '2020-08-17 18:48:28', 'Administrator', 'cdddbbd30f99196214f8931780a2756a.jpg'),
(15, 'UNIT USAHA - JASA OPERASI', '<p>BIDANG JASA</p>\r\n\r\n<hr />\r\n<p>Seat Management, Spare Part Management System, Rental Alat Ukur, Jasa Pengemudi, Rental Kendaraan, Property, Maintenance AC.</p>\r\n', '2020-08-17 18:50:36', 'Administrator', '179e742abfea66647a34065b76412ec7.jpg'),
(16, 'UNIT USAHA - AGEN AMDK JATILUHUR', '<hr />\r\n<p>Melayani&nbsp; kebutuhan air minum dalam kemasan dengan jumlah yang banyak.<br />\r\nMelayani costumer labeling untuk menyediakan air minum dalam kemasan dengan merk sendiri.</p>\r\n', '2020-08-17 18:52:16', 'Admin', '4f78246e662f6e7bdae034218fa66fb0.jpg'),
(17, 'UNIT USAHA - WARUNG INTIMART', '<hr />\r\n<p>Melayani kebutuhan Anggota Koperasi INTI, khususnya karyawan di lingkungan PT INTI (Persero) dan masyarakat.</p>\r\n', '2020-08-17 18:53:43', 'Admin', 'a55241594068b5911fbfd4b1b54871ab.jpg'),
(18, 'UNIT SIMPAN PINJAM', '<hr />\r\n<p>Menghimpun dana dari anggota dalam bentuk Simpanan Pokok, Simpanan Wajib, Simpanan Sukarela dan Simpanan Berjangka.<br />\r\nMemberikan pelayanan bagi anggota dalam bentuk pinjaman reguler dan pinjaman bank serta pembiayaan pembelian barang / investasi untuk anggota.<br />\r\nStandar Kelayakan memperoleh pinjaman dari koperasi INTI, diukur dari 5 kriteria yaitu:<br />\r\nCharacter (Watak)<br />\r\nCollateral (Jaminan)<br />\r\nCapacity (Kemampuan)<br />\r\nCapital (Modal)<br />\r\nCondition (Kondisi)</p>\r\n', '2020-08-17 18:54:39', 'Admin', 'b1dec92f4c223f2df8defb1db561de44.jpg');
...
ALTER TABLE `tbl_photo`
  ...
  ADD KEY `photo_album_id` (`photo_album_id`) USING BTREE,
  ADD KEY `photo_pengguna_id` (`photo_pengguna_id`) USING BTREE;
...
--
ALTER TABLE `tbl_post_views`
  MODIFY `views_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
